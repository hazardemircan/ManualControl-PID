...
if(yukseklik_pwmY>1550)
{
  onsolcontrol=yukseklik_pwmY-control_signal+control_signal_p;
  onsagcontrol=yukseklik_pwmY+control_signal+control_signal_p;
  arkasolcontrol=yukseklik_pwmY-control_signal-control_signal_p;
  arkasagcontrol=yukseklik_pwmY+control_signal-control_signal_p;
